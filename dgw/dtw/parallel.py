...
def _parallel_dtw_worker(data_buffer, operations_generator, data_buffer_shape, result_buffer, scheduling_queue, exception_queue, dtw_args, dtw_kwargs):
    """
...
def parallel_pdist(three_dim_array, n_processes=None, *dtw_args, **dtw_kwargs):
    ...
    return _parallel_dtw(three_dim_array, _pdist_operations_generator_factory, number_of_combinations, n_processes=n_processes,
                         *dtw_args, **dtw_kwargs)


def _path_calculation_worker(data_buffer, shape, prototypes_buffer, prototypes_shape, scheduling_queue, results_queue, exception_queue, dtw_args, dtw_kwargs):
    import sys
    import traceback
    import os
