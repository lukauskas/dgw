...
class TestReadExtendFunctions(unittest.TestCase):
    def test_extend_regular_read(self):
        ...
        start, end = bam_parser.extend_read_to(aligned_read, 100)
    ...
    def test_invalid_extend_raises_exception(self):
        ...
        with self.assertRaises(ValueError):
            bam_parser.extend_read_to(aligned_read, 10) # 0 < 36
...
class TestReadCountForRegionReading(unittest.TestCase):
    ...
    def test_non_extended_read_no_binning(self):
        peak_data = bam_parser.read_samfile_region(self.samfile, 'chr1', 3, 40, resolution=1, extend_to=None)
    ...
    def test_non_extended_read_binning(self):
        ...
        peak_data = bam_parser.read_samfile_region(self.samfile, 'chr1', 3, 43, resolution=5, extend_to=None)
        correct = np.array([1,2,2,2,2,2,1,0])

        assert_array_equal(correct, peak_data)

    def test_extended_read_no_binning(self):
        peak_data = bam_parser.read_samfile_region(self.samfile, 'chr1', 3, 40, resolution=1, extend_to=15)
    ...
    def test_extended_read_binning(self):
        peak_data = bam_parser.read_samfile_region(self.samfile, 'chr1', 3, 43, resolution=5, extend_to=15)
    ...
    def test_extended_read_no_binning_extended_boundaries(self):
        ...
        peak_data = bam_parser.read_samfile_region(self.samfile, 'chr1', 16, 18, resolution=1, extend_to=15)
        ...
        peak_data = bam_parser.read_samfile_region(self.samfile, 'chr1', 39, 43, resolution=1, extend_to=15)
        ...
        peak_data = bam_parser.read_samfile_region(self.samfile, 'chr1', 41, 44, resolution=1, extend_to=15)
        ...
        peak_data = bam_parser.read_samfile_region(self.samfile, 'chr1', 0, 6, resolution=1, extend_to=15)
        ...
        peak_data = bam_parser.read_samfile_region(self.samfile, 'chr1', 0, 5, resolution=1, extend_to=15)
    ...
    def test_extended_reads_extended_boundaries_binning(self):
        ...
        peak_data = bam_parser.read_samfile_region(self.samfile, 'chr1',18, 39, resolution=7, extend_to=15)
